          ...
          options: [
            {
              ...
              value: "Need help?",
              to:
                "https://github.com/perry19/reactnd_project_would_you_rather#introduction"
            },
        ...
        headerProps={{
          ...
          navItems: (
            <Nav.Item type="div" className="d-none d-md-flex">
              <Button
                href="https://github.com/perry19/reactnd_project_would_you_rather"
                target="_blank"
                outline
                size="sm"
                RootComponent="a"
              ...
              <Grid.Col auto={true}>
                <List className="list-inline list-inline-dots mb-0">
                  <List.Item className="list-inline-item">
                    <a href="https://github.com/perry19/reactnd_project_would_you_rather#introduction">
                      Documentation
                    </a>
                  </List.Item>
                  <List.Item className="list-inline-item">
                    <a href="https://github.com/perry19/reactnd_project_would_you_rather/issues">
                      Issues
                    </a>
                  </List.Item>
                </List>
